...
def main(mat_in, feat_in, bc_in, bb_map, ad_out, feat_col=1, remove_zero_features=False):
    # Count matrix
...
if __name__ == '__main__':
    ...
    parser.add_argument('--ad_out', required=True, help='Output AnnData file (h5ad format)')
    parser.add_argument('--feat_col', type=int, default=1, help='Feature column index in the feature file (default: 1)')
    ...
    main(args.mat_in, args.feat_in, args.bc_in, args.bb_map, args.ad_out, args.feat_col, args.remove_zero_features)