...
DOWNSAMPLE1 = (
    ...
    + "/STARsolo/short_read/"
    + RECIPE
    + "/Downsample1Aligned.sortedByCoord.out.bam"
)
DOWNSAMPLE2 = (
    OUTDIR
    + "/"
    ...
    + "/STARsolo/short_read/"
    + RECIPE
    + "/Downsample2Aligned.sortedByCoord.out.bam"
)
BAMDEDUP = (
    OUTDIR
    + "/"
...
DOWNSAMPLE1DEDUP = (
    ...
    + "/STARsolo/short_read/"
    + RECIPE
    + "/Downsample1Aligned.sortedByCoord.dedup.out.bam"
)
DOWNSAMPLE2DEDUP = (
    OUTDIR
    + "/"
    ...
    + "/STARsolo/short_read/"
    + RECIPE
    + "/Downsample2Aligned.sortedByCoord.dedup.out.bam"
)
# Temps
...
dataFrame = pd.DataFrame(
    columns=["No Downsample", "Downsample1", "Downsample2"],
    index=["Downsample Value", "Saturation Value"],
    data=[downsampling, dedup_reads],
)
